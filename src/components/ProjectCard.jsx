...
export default function ProjectCard() {
  return (
    <div className="projects_flex">
        ...
        <div class="cookieCard" data-aos="zoom-in">
            <img src={pro3} alt="" width={260} height={100} style={{zIndex:"1"}} />
        ...
        <div class="cookieCard" data-aos="zoom-in">
            ...
            <button style={{width:"100%"}} class="acceptButton" onClick={()=>window.open("http://localhost:5173/","_blank")}><i class="bi bi-link-45deg"></i> Get code</button>
        </div>
    </div>
  )
}
